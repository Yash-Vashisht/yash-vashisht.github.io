      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <button className="inline-flex items-center gap-3 px-8 py-4 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-all shadow-lg hover:scale-105 mb-8">
              <Download size={20} />
              ...
              {highlights.map((highlight) => {
                ...
                return (
                  <div key={highlight.title} className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-gray-900 mb-1">{highlight.title}</p>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 w-48 h-48 bg-blue-500 rounded-2xl -z-10"></div>
            <div className="absolute -top-6 -right-6 w-48 h-48 bg-purple-500 rounded-2xl -z-10"></div>
          </motion.div>
        </div>
      </div>
    </section>
