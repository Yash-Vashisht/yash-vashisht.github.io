          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden aspect-[4/3]">
                ...
                />
                {/* Mobile-friendly overlay - always shows on mobile, hover on desktop */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent md:opacity-0 md:group-hover:opacity-100 transition-opacity flex items-end p-4 sm:p-6">
